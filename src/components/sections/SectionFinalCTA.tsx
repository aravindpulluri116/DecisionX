      ...
      <div className="relative mx-auto max-w-[1400px] px-6 py-24 md:py-32">
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link href="/workspace">
              <MagneticButton className="!bg-signal !text-white hover:!bg-band-foreground hover:!text-band">
                Open workspace
            ...
            <MagneticButton
              variant="ghost"
              className="!border-band-foreground/20 !text-band-foreground hover:!border-band-foreground/40 hover:!bg-band-foreground/5"
              onClick={() =>
          ...
          <div className="mt-14 flex flex-wrap items-center justify-center gap-8 font-mono-data text-[10px] uppercase tracking-[0.2em] text-band-foreground/30">
            <span>7 AI agents</span>
            <span className="hidden h-3 w-px bg-band-foreground/15 sm:block" />
